...
mkHtmlRenderer maxw cellDict onchanged =
    ...
    , html =
        Markdown.Html.oneOf
            ...
            , Markdown.Html.tag "blockquote" (\htmls -> Html.blockquote [] htmls)
            , Markdown.Html.tag "thead" (\htmls -> Html.thead [] htmls)
            , Markdown.Html.tag "td" (\htmls -> Html.td [] htmls)
            , Markdown.Html.tag "h1" (\htmls -> Html.h1 [] htmls)
            , Markdown.Html.tag "h2" (\htmls -> Html.h2 [] htmls)
            , Markdown.Html.tag "h3" (\htmls -> Html.h3 [] htmls)
            , Markdown.Html.tag "h4" (\htmls -> Html.h4 [] htmls)
            , Markdown.Html.tag "h5" (\htmls -> Html.h5 [] htmls)
            , Markdown.Html.tag "img" (\htmls -> Html.img [] htmls)
            , Markdown.Html.tag "tr" (\htmls -> Html.tr [] htmls)
            ...
            , Markdown.Html.tag "ul" (\htmls -> Html.ul [] htmls)
